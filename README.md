...
- **In-App PDF Preview**: 생성된 PDF를 앱 내부 뷰어에서 확인하고, 미리보기만 안전하게 닫아 편집기로 복귀
- **Document Close UX**: 상단 문서 닫기 `X`와 `파일 -> 닫기` 메뉴를 제공하며, 앱 종료와 문서 닫기 역할을 분리
- **Unsaved Change Guard**: 문서 닫기와 앱 종료 시 미저장 변경을 감지해 저장 여부를 확인
