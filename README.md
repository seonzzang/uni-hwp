...
| --- | --- | --- | --- | --- |
| 8.8.6 | 0.1.0 | 2026-09-14 | `edwardkim/rhwp@v0.8.6` | RHWP 엔진 업데이트·검증·복원 기반과 제품 버전 표시를 정리한 현재 릴리즈입니다.
| 8.4.0 | 0.1.0 | 2026-08-15 | `edwardkim/rhwp@v0.8.4` | RHWP 엔진 코어를 `v0.7.8`에서 `v0.8.4`로 상향한 릴리즈입니다.
| 8.1.102 | 0.1.0 | 2026-04-29 | `edwardkim/rhwp@v0.7.8` | 브라우저형 RHWP 편집기를 Tauri + Rust + Vite 기반 독립 실행 데스크톱 앱으로 포장하고 앱 셸 경계를 정리했습니다.
| 8.1.101 | 0.1.0 | 2026-04-29 | `edwardkim/rhwp@v0.7.8` | 문서 닫기 UX와 인쇄/PDF 미리보기 흐름을 정리했습니다.
| 8.1.100 | 0.1.0 | 2026-04-29 | `edwardkim/rhwp@v0.7.8` | Tauri 기반 독립 실행 편집기 셸의 초기 기준점입니다.

현재 Uni-HWP 통합 버전은 `8.8.6`, 외피/API 버전은 `0.1.0`, 엔진 기준선은 `edwardkim/rhwp@v0.8.6`입니다.
