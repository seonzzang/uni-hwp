...
현재 Uni-HWP 외피/API 버전은 `0.1.0`이며, RHWP 기준선은 `edwardkim/rhwp@v0.8.6`입니다. 전체 식별 버전은 `8.8.6`입니다.

| Uni-HWP 버전 | 외피/API 버전 | 릴리즈 날짜 | RHWP 대응 버전 | 비고 |
| --- | --- | --- | --- | --- |
| 8.8.6 | 0.1.0 | 2026-09-14 | `edwardkim/rhwp@v0.8.6` | RHWP 엔진 업데이트·검증·복원과 제품 버전 표시를 정리한 현재 릴리즈 |
