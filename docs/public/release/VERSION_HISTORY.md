...
현재 Uni-HWP 외피/API 버전은 `0.1.0`이며, RHWP 기준선은 `edwardkim/rhwp@v0.8.6`입니다. 전체 식별 버전은 `8.6.0`입니다.

| Uni-HWP 버전 | 외피/API 버전 | 릴리즈 날짜 | RHWP 대응 버전 | 비고 |
| --- | --- | --- | --- | --- |
| 8.6.0 | 0.1.0 | 2026-09-14 | `edwardkim/rhwp@v0.8.6` | RHWP 엔진 업데이트·검증·복원과 제품 버전 표시를 정리한 현재 릴리즈 |
| 8.4.0 | 0.0.9 | 2026-08-15 | `edwardkim/rhwp@v0.8.4` | RHWP 엔진 코어를 `v0.7.8`에서 `v0.8.4`로 상향한 릴리즈 |
| 8.1.102 | 0.0.8 | 2026-04-29 | `edwardkim/rhwp@v0.7.8` | 독립 실행 데스크톱 앱과 Uni-HWP 앱 셸 경계를 정리한 릴리즈 |
| 8.1.101 | 0.0.7 | 2026-04-29 | `edwardkim/rhwp@v0.7.8` | 문서 닫기 UX와 인쇄/PDF 미리보기 흐름을 정리한 릴리즈 |
| 8.1.100 | 0.0.6 | 2026-04-29 | `edwardkim/rhwp@v0.7.8` | Tauri 기반 독립 실행 편집기 셸의 초기 기준점 |
