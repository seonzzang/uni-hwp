...
현재 Uni-HWP 외피/API 버전은 `0.1.0`이며, 테스트 시작 RHWP 기준선은 `edwardkim/rhwp@v0.8.4`입니다. 전체 식별 버전은 `8.4.0`이고 엔진 업데이트 후보 `v0.8.6` 적용 후 `8.6.0`으로 표시합니다.

| Uni-HWP 버전 | 릴리즈 날짜 | RHWP 대응 버전 | 비고 |
| --- | --- | --- | --- |
| 8.6.0 | 0.1.0 | 2026-09-14 | `edwardkim/rhwp@v0.8.6` | 엔진 업데이트·검증·복원 기준 |
| 8.6.0 | 2026-09-14 | `edwardkim/rhwp@v0.8.6` | RHWP 런타임 엔진 업데이트·검증·복원과 제품 버전 자동 정렬을 반영한 현재 릴리즈 |
| 8.4.0 | 2026-08-15 | `edwardkim/rhwp@v0.8.4` | RHWP 엔진 코어를 `v0.7.8`에서 `v0.8.4`로 상향한 릴리즈 |
